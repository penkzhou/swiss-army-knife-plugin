...
description: Use this agent to fetch all review comments from a GitHub PR. Retrieves both review comments (on code lines) and issue comments (general discussion).
model: sonnet
tools: Bash
---
