...
skills: ci-job-analysis, bugfix-workflow, coordinator-patterns
---
...
**置信度上限处理**：
- 如果 `workflow_ctx.blocks_auto_fix == true`，强制将所有分类的置信度上限设为 39
...
```json
{
  ...
  "report_path": "docs/ci-fix-reports/2024-01-15-job-67890.md",
